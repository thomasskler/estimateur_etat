...
# main method for doing speed test
    def SpeedLoop(self):
        ...
        # End;
        # End;
        DSSLoads = self.circuit.Loads
        print "Starting SpeedLoop"
        for i in range(0, 999):
            iLine = DSSLoads.First
            while iLine > 0:
        			DSSLoads.kW = 100.0
        			DSSLoads.kvar = 20.0
        			iLine = DSSLoads.Next
...
if __name__ == '__main__':
    d = DSS(r"C:\Users\prdu001\OpenDSS\Distrib\IEEETestCases\8500-Node\Master.dss")
    d.SpeedLoop()
    print "Done"
